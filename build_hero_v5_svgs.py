...
def create_photorealistic_svgs():
    # 1. Read and base64 encode the 600x600 photorealistic portrait
    avatar_path = "realistic_portrait_resized.jpg"
  ...
  <!-- ========================================================= -->
  <!-- LEFT PANEL: PHOTOREALISTIC SOFTWARE ENGINEER PORTRAIT      -->
  <!-- ========================================================= -->
  <g id="left-panel" filter="url(#cardShadow)">
    ...
    <g clip-path="url(#leftCardClip)">
      ...
      <!-- Header Title -->
      <text x="242" y="56" text-anchor="middle" fill="{text_secondary}" font-family="'JetBrains Mono', monospace" font-size="11" font-weight="600">engineer_portrait.jpg — ujjwal@dev</text>
    ...
    <!-- EMBEDDED PHOTOREALISTIC SOFTWARE ENGINEER PORTRAIT -->
    <g clip-path="url(#insetClip)">
      <g>
        ...
        <rect x="58" y="524" width="220" height="28" rx="14" fill="rgba(15, 23, 42, 0.75)" stroke="rgba(255, 255, 255, 0.15)" stroke-width="1"/>
        <circle cx="72" cy="538" r="3.5" fill="{grad_c3}"/>
        <text x="83" y="542" fill="#F8FAFC" font-family="'JetBrains Mono', monospace" font-size="10" font-weight="600">STATUS: ACTIVE | STUDIO_RAW</text>
      </g>
    </g>
  </g>
